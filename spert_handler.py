...
class ModelHandler(object):
    ...
    def initialize(self, ctx):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("Zichuu/spert")
        
        #load types_file
        types_path=os.path.join(model_dir, "conll04_types.json")
        ...
        #load config
        config = AutoConfig.from_pretrained("Zichuu/spert")
